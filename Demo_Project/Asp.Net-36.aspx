<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Asp.Net-36.aspx.cs" Inherits="Demo_Project.Asp_Net_36" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Wizard ID="Wizard1" runat="server"
                ...
                OnNextButtonClick="Wizard1_NextButtonClick" ActiveStepIndex="1">
                ...
                <WizardSteps>
                    ...
                    <asp:WizardStep ID="WizardStep2" runat="server" StepType="Step" Title="Step 2 - Contact Details">
                        <table style="border: 1px solid black">
                            <tr>
                                <td>Email Address
                                </td>
                    ...
                    <asp:WizardStep ID="WizardStep3" runat="server" StepType="Finish" Title="Step 3 - Summary">
                        <table style="border: 1px solid black">
                            <tr>
                                <td colspan="2">
